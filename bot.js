...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("Diamond City Server Status", "https://cdn.discordapp.com/attachments/796099884120801310/797659634868551761/Diamond_City_Blue_Purple_Background.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '💎 Diamond City' : '🕹️ Gaming')
    .setTimestamp(new Date())
    .addField('\n\u200b\n💎 DIAMOND CITY GAMING 💎','Hier wird der Status des Gaming Servers angezeigt. Abonniere Django/CrumbL doch auf [YouTube!](https://www.youtube.com/channel/UCqcj9-S8xp2TnpW3bSQcfKw)\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  const updateMessage = function() {
    getVars().then((vars) => {
      getPlayers().then((players) => {
        ...
        .addField('Spieler Online',`${players.length}/${MAX_PLAYERS}\n\u200b\n`,true);
        // .addField('\u200b','\u200b\n\u200b\n',true);
        if (players.length > 0) {
          // method D
          const fieldCount = 3;
  ...
  bot.on('ready',() => {
    ...
    // bot.user.setGame('Roofstad', 'https://www.youtube.com/channel/UCqcj9-S8xp2TnpW3bSQcfKw');
    bot.user.setActivity('💎DIAMOND CITY💎',{'url':'https://www.youtube.com/channel/UCqcj9-S8xp2TnpW3bSQcfKw','type':'STREAMING'});
